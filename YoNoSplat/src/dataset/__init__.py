...
from .dataset_dl3dv_raw import DatasetDL3DVRaw, DatasetDL3DVRawCfg, DatasetDL3DVRawCfgWrapper
...
DatasetCfgWrapper = (
    ...
    | DatasetDL3DVRawCfgWrapper
    | DatasetScannetppCfgWrapper
    | DatasetScannetPoseCfgWrapper
)
DatasetCfg = DatasetRE10kCfg | DatasetDL3DVRawCfg
